...
public class EscapeChar {
	...
	public static void main(String[] args) {
		/* 이스케이프 문자
		 * 프로그래 코드에서 사용하는 문자가 문자열에서 사용하는 문자와 중첩되는 경우 
		 ...
		 * \t : 문자열 안에서 탭 공백(8칸 공백)을 사용하기 위해 쓰인다.
		 * \" : 문자열 안에서 쌍따옴표 문자를 사용하기 위해 쓰인다. 
		 * \' : 문자열 안에서 홑따옴표 문자를 사용하기 위해 쓰인다. 
		 * \\ : 문자열 안에서 역슬래쉬 문자를 사용하기 위해 쓰인다. 
		 */
		
		System.out.print("안녕하세요.\n반갑습니다.\n");
		
		System.out.println("abcd\r12"); // eclipse의 콘솔에서는 적용 안됨(확인 불가능)
		
		System.out.println("abcd\t");
		System.out.println("abc\t");
		System.out.println("ab\t");
		
		System.out.println("안녕하세요. \"자바\" 프로그래밍 수업을 시작합니다.");
		
		System.out.println("안녕하세요. '자바' 프로그래밍 수업을 시작합니다.");
		// = System.out.print("안녕하세요. \'자바\' 프로그래밍 수업을 시작합니다.");
		// 큰따옴표 안에 있는 홑따옴표는 이스케이프 문자 안써줘도 됨
		System.out.println("'");
		System.out.println('\'');
